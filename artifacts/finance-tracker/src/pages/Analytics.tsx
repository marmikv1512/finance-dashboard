...
const COLORS = ['hsl(153, 60%, 53%)', 'hsl(210, 100%, 56%)', 'hsl(270, 60%, 60%)', 'hsl(30, 90%, 60%)', 'hsl(0, 84%, 60%)', 'hsl(180, 50%, 50%)'];
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={trends || []} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                    ...
                    <RechartsTooltip 
                      ...
                      formatter={(value: number) => formatCurrency(value)}
                    />
                    <Line type="monotone" dataKey="savings" stroke="hsl(153, 60%, 53%)" strokeWidth={3} dot={{ r: 4, fill: 'hsl(153, 60%, 53%)' }} activeDot={{ r: 6 }} />
                  </LineChart>
                </ResponsiveContainer>
              )}
            </div>
